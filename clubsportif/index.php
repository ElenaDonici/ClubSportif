...
<head>
    ...
    <meta name="keywords" content="sport, gym, yoga, cardio, football">
    <!-- Mobile viewport -->
    ...
    <header>
        ...
        <div class="container">
            <div class="top-container">
                ...
                <div class="slogan">
                    <a href="php/deconnexion.php"><input class="registration" id="registration" type="button" name="registration" formaction="php/registration.php" value="déconnexion" /> </a>
                            ...
                            <li>
                                <form method="POST" action='index.php'>
                                    ...
                                    <span>
                                      ...
                                      if($nbInscrit>=$nbMax)
                                      if($id == $activite['activite_id']){   echo $complet_message;   
    ...
    <footer>
        <div class="footer">
            ...
            <div>
                ...
                <p><a href="https://pixabay.com/en/swimmers-swimming-race-competition-79592/" target="_blank">Image Natation</a></p>
                <p><a href="https://pixabay.com/en/yoga-asana-pose-hatha-woman-girl-2959226/" target="_blank">Image Yoga</a></p>
                <p><a href="https://pixabay.com/en/weights-health-happy-sports-1948813/" target="_blank">Image Cardio</a></p>
                <p><a href="https://pxhere.com/fr/photo/774994" target="_blank">Image soccer</a></p>
